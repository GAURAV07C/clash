...
const __dirname = path.dirname(fileURLToPath(import.meta.url)); // current dir path 
...
app.use(express.json()); /// json dsata accept
app.use(express.urlencoded({ extended: false }));// api call acceptr 
